...
public class VirtualMachineIntegerTest {
    ...
    public void testIntegerConstToStack() {
        long actualValue = simpleIntTest(Arrays.asList(
            new Instruction(InstructionCode.INTEGER_TO_STACK, -534L)
        ));
        
        assertEquals(-534L, actualValue);
    }
    ...
    public void testIntegerAdd() {
        long actualValue = simpleIntTest(Arrays.asList(
            ...
            new Instruction(InstructionCode.INTEGER_TO_STACK, 17L),
            new Instruction(InstructionCode.INTEGER_ADD)
        ));
        
        assertEquals(29L, actualValue);
    }
    ...
    public void testIntegerSubtract() {
        long actualValue = simpleIntTest(Arrays.asList(
            ...
            new Instruction(InstructionCode.INTEGER_SUBTRACT)
        ));
    ...
    public void testIntegerMultiply() {
        long actualValue = simpleIntTest(Arrays.asList(
            new Instruction(InstructionCode.INTEGER_TO_STACK, 22L),
            new Instruction(InstructionCode.INTEGER_TO_STACK, -7L),
            new Instruction(InstructionCode.INTEGER_MULTIPLY)
        ));
        
        assertEquals(-154L, actualValue);
    }
    
    @Test
    public void testIntegerDivide() {
        long actualValue = simpleIntTest(Arrays.asList(
            new Instruction(InstructionCode.INTEGER_TO_STACK, 42L),
            new Instruction(InstructionCode.INTEGER_TO_STACK, 5L),
            new Instruction(InstructionCode.INTEGER_DIVIDE)
        ));
        
        assertEquals(8L, actualValue);
    }
    
    @Test
    public void testIntegerModulus() {
        long actualValue = simpleIntTest(Arrays.asList(
            new Instruction(InstructionCode.INTEGER_TO_STACK, 202L),
            new Instruction(InstructionCode.INTEGER_TO_STACK, 10L),
            new Instruction(InstructionCode.INTEGER_MODULUS)
        ));
